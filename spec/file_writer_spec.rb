...
describe Forgery::FileWriter do
  ...
  it "should create a dictionary file an html page" do
    file = File.open("spec/data/documents/mock_web_page.html")
    doc = Nokogiri.parse(file)
    file.close
    Forgery::FileWriter.stub!(:open_page).and_return(doc)
  ...
  it "should create a dictionary file from xml content" do
    file = File.open("spec/data/documents/mock_xml_doc.xml")
    doc = Nokogiri.parse(file)
    file.close
    Forgery::FileWriter.stub!(:open_page).and_return(doc)
